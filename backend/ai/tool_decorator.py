...
from .base_models import BaseTool
from .schema_util import pydantic_inline_ref_schema
import ai
...
def tool(description: str, is_public: bool = False, force_if: Optional[Callable[['ai.base_prompt.BasePrompt'], bool]] = None):
    """
...
class ToolWrapper(BaseTool):
    def __init__(self, func: Callable[..., Awaitable[Any]], description: str):
        ...
        self.force_if: Optional[Callable[['ai.base_prompt.BasePrompt'], bool]] = None
